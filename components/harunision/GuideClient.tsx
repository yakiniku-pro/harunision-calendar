  ...
  return (
    <main className="container mx-auto p-4 md:p-8 max-w-4xl">
      ...
      <section id="tickets" className="infographic-section scroll-reveal">
        ...
        <div className="mt-3"><a href="https://harunision-official.boosty.app/schedules" target="_blank" rel="noopener noreferrer" className="inline-block p-3 bg-gradient-to-r from-sky-200 to-amber-100 text-slate-700 rounded-xl hover:from-sky-100 hover:to-amber-50 transition font-bold text-center shadow-md border border-white/80">スケジュールをチェック</a></div></p>
